    ...
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} {...args}>
        ...
        <ModalBody>
          ...
          is comprised entirely of Reactstrap  components and the frontend is a single page app that uses the react-router-dom library for navigation. 
          You can use the Navbar to navigate to my Github, resume, and some of my personal projects. 
        </ModalBody>
        <ModalFooter>
